...
p.init(moutPort);
PushKnob k[nDrums][nPages][4]; //drum, page#, # of knobs
/*
PushKnob aux[3];
...
for(0=>int i;i<nDrums;i++){
    for(0=>int j;j<nPages;j++){
        k[i][j][0].init(0,p,minPort,"Trim");
        k[i][j][0].cursorStyle(3);
        
        k[i][j][1].init(1,p,minPort,"Pitch");
        k[i][j][1].cursorStyle(2);
        k[i][j][1].valueScale(2);
        
        k[i][j][2].init(2,p,minPort,"Pan");
        k[i][j][2].cursorStyle(2);
        k[i][j][2].valueOffset(-1);
        k[i][j][2].valueScale(2);
        
        k[i][j][3].init(3,p,minPort,"Sample");
        k[i][j][3].displaysValue(0);
        k[i][j][3].textPosY(1);
        k[i][j][3].cursorStyle(3);
        k[i][j][3].pos(0);
        k[i][j][3].selfIncrement(0);
        
        spork ~ printValue(k[i][j][0]);
        spork ~ printValue(k[i][j][1]);
        spork ~ printValue(k[i][j][2]);
        spork ~ printValue(k[i][j][3]);
        /*
...
spork~incListen(k[0][0][3],nKck);
spork~decListen(k[0][0][3],nKck);

spork~incListen(k[1][0][3],nSnr);
spork~decListen(k[1][0][3],nSnr);

spork~incListen(k[2][0][3],nClp);
spork~decListen(k[2][0][3],nClp);

spork~incListen(k[3][0][3],nChh);
spork~decListen(k[3][0][3],nChh);

spork~incListen(k[4][0][3],nOhh);
spork~decListen(k[4][0][3],nOhh);

spork~incListen(k[5][0][3],nLtm);
spork~decListen(k[5][0][3],nLtm);

spork~incListen(k[6][0][3],nHtm);
spork~decListen(k[6][0][3],nHtm);

spork~incListen(k[7][0][3],nCym);
spork~decListen(k[7][0][3],nCym);
...
for(0=>int i;i<8;i++){
    ...
    spork~knobValue(k[i][0][3],drumSeqs[i],3);
