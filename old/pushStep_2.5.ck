...
for(0=>int i;i<nDrums;i++){
    drumSeqs[i].connectMaster(dac.chan(0),dac.chan(1));
...
fun void initSounds(){
    ...
    drumSeqs[0].init(mB,0,0,8,4,64, kck, minPort, moutPort, 0,1,2,3);
    ...
    drumSeqs[1].init(mB,0,0,8,4,64, snr, minPort, moutPort, 0,1,2,3);
    ...
    drumSeqs[2].init(mB,0,0,8,4,64, clp, minPort, moutPort, 0,1,2,3);
    ...
    drumSeqs[3].init(mB,0,0,8,4,64, chh, minPort, moutPort, 0,1,2,3);
    ...
    drumSeqs[4].init(mB,0,0,8,4,64, ohh, minPort, moutPort, 0,1,2,3);
    ...
    drumSeqs[5].init(mB,0,0,8,4,64, ltm, minPort, moutPort, 0,1,2,3);
    ...
    drumSeqs[6].init(mB,0,0,8,4,64, htm, minPort, moutPort, 0,1,2,3);
    ...
    drumSeqs[7].init(mB,0,0,8,4,64, cym, minPort, moutPort, 0,1,2,3);
